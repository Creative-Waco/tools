...
function renderOrganizationOrVenue(item) {
  ...
  <img class="cw-slideshow-card__org-logo" src="${escapeHtml(logoUrl)}" alt="" crossorigin="anonymous" loading="eager" />
</div>`
    : "";
  ...
  ${orgMainHtml}
  <img class="cw-slideshow-card__culturalyst-logo" src="${culturalystUrl}" alt="Culturalyst" crossorigin="anonymous" loading="eager" />
</div>`;
}
