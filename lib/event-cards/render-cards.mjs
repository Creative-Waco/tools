...
function renderOrganizationOrVenue(item) {
  ...
  <img class="cw-ticket__org-logo" src="${escapeHtml(logoUrl)}" alt="" crossorigin="anonymous" loading="eager" />
</div>`
    : "";
  ...
  ${orgMainHtml}
  <img class="cw-ticket__culturalyst-logo" src="${culturalystUrl}" alt="Culturalyst" crossorigin="anonymous" loading="eager" />
</div>`;
}
...
<div class="cw-export-frame" data-card-title="${title}">
  <div class="cw-card-scene">
    <div class="cw-card-backdrop" aria-hidden="true">
      <img src="${imageUrl}" alt="" crossorigin="anonymous" loading="eager" />
    </div>
    <article class="cw-card">
      ...
      <div class="cw-card__post-branding">
        <img class="cw-card__creative-waco-logo" src="${cwLogoUrl}" alt="Creative Waco" crossorigin="anonymous" loading="eager" />
      </div>
    </article>
  </div>
</div>`.trim();
