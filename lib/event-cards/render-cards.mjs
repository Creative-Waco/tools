...
const TOP_SHAPE = `<svg class="cw-ticket__shape" aria-hidden="true" preserveAspectRatio="none">
  <path class="cw-ticket__path cw-ticket__path--top" d="" />
</svg>`;

const BOTTOM_SHAPE = `<svg class="cw-ticket__shape" aria-hidden="true" preserveAspectRatio="none">
  <path class="cw-ticket__path cw-ticket__path--bottom" d="" />
</svg>`;
...
<div class="cw-card-scene" style="width:${cardWidth}px;" data-card-title="${title}">
  ...
  <article class="cw-card">
    <div class="cw-card__ticket">
      <div class="cw-ticket__top">
        ${TOP_SHAPE}
        <div class="cw-ticket__pad">
      ...
      <div class="cw-card__tear" aria-hidden="true"></div>
      <div class="cw-ticket__bottom">
        ${BOTTOM_SHAPE}
        <div class="cw-ticket__pad">
          ${renderVenue(item)}
        </div>
